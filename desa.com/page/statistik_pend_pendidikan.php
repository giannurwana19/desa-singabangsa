...
<div class="row">
    <div class="col-md-12">
        <h5 class="text-center">Kategori Pendidikan</h5>
        ...
        <script type="text/javascript">
            ...
            function drawChart() {
                var data = google.visualization.arrayToDataTable([
                    ...
                    ['sd',
                        <?php
                        $sql = "SELECT count(agama) as hasil_sd from penduduk WHERE pendidikan='sd'";
                ...
                var options = {
                    'title': 'Statistik Pendidikan Di Desa Singabangsa',
                    // 'width': 550,
                    // 'height': 400
                };
