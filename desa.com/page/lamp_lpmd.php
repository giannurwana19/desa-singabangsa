...
<head>
    ...
    <title>Lampiran LPMD - Desa Singabangsa</title>
</head>
...
<body>
    ...
    <section class="py-5">
        <div class="container pt-5" data-aos="fade-top">
            <a href="index.php?page=profil">Kembali</a>
            <h5 class="text-center mb-4 mt-4">Dokumen Lampiran LPMD</h5>
            <div class="row mb-3">
                <div class="col">
                    <iframe src="../doc_lembaga_masy/lpmd.pdf" style="width:100%; height:600px;"></iframe>
                </div>
            </div>
            <hr>
        </div>
